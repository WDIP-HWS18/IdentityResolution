package de.uni_mannheim.informatik.dws.wdi.ExerciseIdentityResolution.solutions.machineLearning.BlockingBySongName.SortedNeighbourhoodBlocker;
...
public class IR_using_machine_learning_lyrics_songdata {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        WekaMatchingRule<Music, Attribute> matchingRule = new WekaMatchingRule<>(0.9, modelType, options);
        ...
        SortedNeighbourhoodBlocker<Music, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MusicBlockingKeyBySongNameGenerator(), 40);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/lyrics_songdata_correspondences_machine_learning.csv"), correspondences);
        ...
        System.out.println("lyrics <-> songdata");
