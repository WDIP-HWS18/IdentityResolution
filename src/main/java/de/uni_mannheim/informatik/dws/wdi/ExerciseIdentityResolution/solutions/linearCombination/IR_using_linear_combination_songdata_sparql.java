...
public class IR_using_linear_combination_songdata_sparql
{
    /*
     * Logging Options:
...
//		NoBlocker<Music, Attribute> blocker = new NoBlocker<>();
	//	SortedNeighbourhoodBlocker<Music, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MusicBlockingKeyBySongNameGenerator(), 1);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/songdata_sparql_correspondences.csv"), correspondences);

        // load the gold standard (test set)
        System.out.println("*\n*\tLoading gold standard\n*");
        MatchingGoldStandard gsTest = new MatchingGoldStandard();
        gsTest.loadFromCSVFile(new File(
                "data/goldstandard/python/gs_songdata_sparql_test.csv"));
        ...
        System.out.println("songdata <-> sparql (IR_using_linear_combination_songdata_sparql)");
