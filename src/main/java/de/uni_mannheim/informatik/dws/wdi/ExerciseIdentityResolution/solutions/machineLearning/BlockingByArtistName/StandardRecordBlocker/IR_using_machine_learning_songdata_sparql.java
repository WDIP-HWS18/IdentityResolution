...
public class IR_using_machine_learning_songdata_sparql {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/songdata_sparql_correspondences_machine_learning.csv"), correspondences);
        ...
        System.out.println("songdata <-> sparql");
